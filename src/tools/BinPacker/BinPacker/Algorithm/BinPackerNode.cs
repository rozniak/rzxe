/**
 * BinPackerNode.cs - Bin Packer Algorithm Tree Node
 *
...
namespace Oddmatics.Rzxe.Tools.BinPacker.Algorithm
{
    ...
    internal sealed class BinPackerNode
    {
        ...
        /// </summary>
        public BinPackerNode LeftChild { get; set; }

        /// <summary>
        /// Gets or sets the "right-hand" child node of this node.
        /// </summary>
        public BinPackerNode RightChild { get; set; }


        /// <summary>
        /// Initializes a new instance of the <see cref="BinPackerNode"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BinPackerNode"/> class with
        ...
        /// The node's "left-hand" child node.
        /// </param>
        /// <param name="rightChild">
        /// The node's "right-hand" child node.
        /// </param>
        /// <param name="leafName">
        ...
        /// <summary>
        /// Attempts to insert a new node.
        /// </summary>
        /// <param name="node">
        /// The node to insert.
        /// </param>
        /// <param name="rect">
        /// The bounding box rectangle of the node.
        /// </param>
        /// <returns>
        /// The inserted node.
        /// </returns>
        public BinPackerNode Insert(
            BinPackerNode node,
            Rectangle     rect
        )
        {
            ...
            else
            {
                ...
                if (deltaWidth > deltaHeight)
                {
                    ...
                    node.RightChild.Bounds =
                        new Rectangle(
                            node.Bounds.X + rect.Width,
                            node.Bounds.Y,
                            node.Bounds.Width - rect.Width,
                            node.Bounds.Height
                        );
